...
labels_list = ["B-company", "I-company", 'O', "B-name", "I-name", 
               ...
               "B-movie", "I-movie", "B-position", "I-position","B-skill", "I-skill"
               "B-address", "I-address", "B-government", "I-government",
               "B-scene", "I-scene", "B-book", "I-book",
               "S-company", "S-address", "S-name", "S-position", "S-skill"]
...
if __name__ == "__main__":
    ...
    # 1. 训练中文命名实体识别模型
    #============================================================================
    train_df, _ = load_cluener2020_data("data/CLUENER2020/train.json")
    dev_df, _ = load_cluener2020_data("data/CLUENER2020/dev.json")
    print(train_df.head())
    print(dev_df.head())

    # 创建命名实体识别模型
    # model = NERModel(args.model_type, args.model_name, labels=labels_list, use_cuda=False,args=vars(args))
